...
var $author$project$Cli$print = _Platform_outgoingPort('print', $elm$json$Json$Encode$string);
var $elm$core$Debug$toString = _Debug_toString;
var $author$project$Cli$init = F2(
	function (flags, cliOptions) {
		return $author$project$Cli$print(
			function () {
				switch (cliOptions.$) {
					case 'Init':
						return 'Initialized empty Git repository...';
					case 'Clone':
						var url = cliOptions.a;
						return 'Cloning `' + (url + '`...');
					default:
						...
						return A2(
							...
							A2(
								...
								_List_fromArray(
									[
										$elm$core$Maybe$Just('Logging...'),
										A2(
										$elm$core$Maybe$map,
										function (authorPattern) {
											return 'authorPattern: ' + authorPattern;
										},
										options.maybeAuthorPattern),
										A2(
										$elm$core$Maybe$map,
										function (maxCount) {
											return 'maxCount: ' + $elm$core$String$fromInt(maxCount);
										},
										options.maybeMaxCount),
										$elm$core$Maybe$Just(
										'stat: ' + $elm$core$Debug$toString(options.statisticsMode)),
										A2(
										$elm$core$Maybe$map,
										function (revisionRange) {
											return 'revisionRange: ' + $elm$core$Debug$toString(revisionRange);
										},
										options.maybeRevisionRange)
									])));
				}
			}());
	});
var $elm$json$Json$Decode$list = _Json_decodeList;
var $author$project$Cli$printAndExitFailure = _Platform_outgoingPort('printAndExitFailure', $elm$json$Json$Encode$string);
var $author$project$Cli$printAndExitSuccess = _Platform_outgoingPort('printAndExitSuccess', $elm$json$Json$Encode$string);
var $author$project$Cli$Clone = function (a) {
	return {$: 'Clone', a: a};
};
var $author$project$Cli$Init = {$: 'Init'};
var $author$project$Cli$Log = function (a) {
	return {$: 'Log', a: a};
};
...
var $author$project$Cli$LogOptions = F5(
	function (maybeAuthorPattern, maybeMaxCount, statisticsMode, maybeRevisionRange, restArgs) {
		return {maybeAuthorPattern: maybeAuthorPattern, maybeMaxCount: maybeMaxCount, maybeRevisionRange: maybeRevisionRange, restArgs: restArgs, statisticsMode: statisticsMode};
	});
...
var $author$project$Cli$maybeToResult = function (maybe) {
	if (maybe.$ === 'Just') {
		var value = maybe.a;
		return $elm$core$Result$Ok(value);
	} else {
		return $elm$core$Result$Err('Could not convert.');
	}
};
...
var $dillonkearns$elm_cli_options_parser$Cli$Option$validateMapIfPresent = F2(
	function (mapFn, cliSpec) {
		var dataGrabber = cliSpec.a.dataGrabber;
		var usageSpec = cliSpec.a.usageSpec;
		var decoder = cliSpec.a.decoder;
		return A2(
...
var $author$project$Cli$logOptionsParser = A2(
	$dillonkearns$elm_cli_options_parser$Cli$OptionsParser$withRestArgs,
	$dillonkearns$elm_cli_options_parser$Cli$Option$restArgs('rest args'),
	A2(
		$dillonkearns$elm_cli_options_parser$Cli$OptionsParser$withOptionalPositionalArg,
		$dillonkearns$elm_cli_options_parser$Cli$Option$optionalPositionalArg('revision range'),
		A2(
			$dillonkearns$elm_cli_options_parser$Cli$OptionsParser$with,
			$dillonkearns$elm_cli_options_parser$Cli$Option$flag('stat'),
			A2(
				$dillonkearns$elm_cli_options_parser$Cli$OptionsParser$with,
				A2(
					$dillonkearns$elm_cli_options_parser$Cli$Option$validateMapIfPresent,
					A2($elm$core$Basics$composeR, $elm$core$String$toInt, $author$project$Cli$maybeToResult),
					$dillonkearns$elm_cli_options_parser$Cli$Option$optionalKeywordArg('max-count')),
				A2(
					$dillonkearns$elm_cli_options_parser$Cli$OptionsParser$with,
					$dillonkearns$elm_cli_options_parser$Cli$Option$optionalKeywordArg('author'),
					A2($dillonkearns$elm_cli_options_parser$Cli$OptionsParser$buildSubCommand, 'log', $author$project$Cli$LogOptions))))));
...
var $author$project$Cli$programConfig = A2(
	$dillonkearns$elm_cli_options_parser$Cli$Program$add,
	A2($dillonkearns$elm_cli_options_parser$Cli$OptionsParser$map, $author$project$Cli$Log, $author$project$Cli$logOptionsParser),
	A2(
		$dillonkearns$elm_cli_options_parser$Cli$Program$add,
		A2(
			$dillonkearns$elm_cli_options_parser$Cli$OptionsParser$with,
			$dillonkearns$elm_cli_options_parser$Cli$Option$requiredPositionalArg('repository'),
			A2($dillonkearns$elm_cli_options_parser$Cli$OptionsParser$buildSubCommand, 'clone', $author$project$Cli$Clone)),
		A2(
			$dillonkearns$elm_cli_options_parser$Cli$Program$add,
			A2(
				$dillonkearns$elm_cli_options_parser$Cli$OptionsParser$withDoc,
				'initialize a git repository',
				A2($dillonkearns$elm_cli_options_parser$Cli$OptionsParser$buildSubCommand, 'init', $author$project$Cli$Init)),
...
var $author$project$Cli$main = $dillonkearns$elm_cli_options_parser$Cli$Program$stateless(
	{config: $author$project$Cli$programConfig, init: $author$project$Cli$init, printAndExitFailure: $author$project$Cli$printAndExitFailure, printAndExitSuccess: $author$project$Cli$printAndExitSuccess});
_Platform_export({'Cli':{'init':$author$project$Cli$main(
	A2(
